...
urlpatterns = [
    ...
    path("incidents/<int:pk>/close/approval/request/", views.incident_close_approval_request, name="incident_close_publish"),
    ...
    path("solutions/filter/", views.solution_list_filter, name="solution_list_filter"),
    ...
    path("solutions/export/", views.solution_list_export, name="solution_list_export"),
    ...
    path("anniversaries/reports/", views.anniversary_report_list, name="anniversary_report_list"),
    path("anniversaries/report/", views.anniversary_report_detail, name="anniversary_report_detail"),
